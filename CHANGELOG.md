...
- Lexicon part-of-speech is a **left rail** (same layout as etymology): noun / verb / adj with no **all** item. The senses panel is one stacked view; clicking a POS jumps to that section (the first POS is the top). Blocks are separated by a thick rule (heavier than the hairline between senses).
