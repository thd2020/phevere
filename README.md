...
**2026-09-04:** Lexicon POS is a horizontal tab row. Each US/UK IPA chip has a speaker (recorded dictionary audio when the API sent an MP3, otherwise the system voice for that accent).
