...
**2026-09-04:** Hover/OCR lookup follows the cursor on HiDPI displays. Toolbar 🔊 caches recorded clips on disk. Lexicon POS tabs use dictionary abbreviations (adj., n., v.) with rules between chips in a card.
