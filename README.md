...
**2026-09-04:** Toolbar 🔊 plays a recorded clip (Free Dictionary or Wiktionary Commons). IPA chips use a persistent Windows speech host so they actually speak. POS **all** view has a thick rule between noun/verb/….

**2026-09-04:** Lexicon POS is a horizontal tab row.
