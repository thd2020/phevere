...
**2026-09-04:** Hover/OCR lookup follows the cursor on HiDPI displays. Toolbar 🔊 caches recorded clips on disk. Lexicon POS tabs use dictionary abbreviations (adj., n., v.); tabs in one rail card are a glued chip with thin hairlines, not a bold rule in the content.
