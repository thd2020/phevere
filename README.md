...
**2026-09-03:** Translation Auto uses Google (free) then MyMemory (free, no key). Youdao/DeepL still need keys in Settings. Installed OCR on images no longer splits letters. PP-OCRv5 downloads the matching dictionary. Setup’s copy page names what is installing.
