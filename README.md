...
**2026-09-03:** Installed OCR on images no longer splits letters (`c e n t r i f i c`). Switching Settings to PP-OCRv5 downloads the matching dictionary (v4 keys left the pack empty). Setup’s copy page names what is installing. Translation tab can pick Auto / Youdao / DeepL / Google.
