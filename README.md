...
**2026-09-04:** Lexicon part-of-speech is a skinny left rail of vertical labels (no leftover column; no **all**). Click the first POS to return to the top. The senses panel is one scrollable view.

**2026-09-04:** Toolbar 🔊 plays a recorded clip (Free Dictionary or Wiktionary Commons). IPA chips use a persistent Windows speech host so they actually speak. POS sections have a thick rule between noun/verb/….
